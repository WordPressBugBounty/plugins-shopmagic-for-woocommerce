...
use ShopMagicVendor\Http\Message\Cookie;
use ShopMagicVendor\Http\Message\CookieJar;
use ShopMagicVendor\Http\Message\CookieUtil;
use ShopMagicVendor\Http\Message\Exception\UnexpectedValueException;
