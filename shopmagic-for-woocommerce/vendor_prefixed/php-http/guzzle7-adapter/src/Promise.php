...
use ShopMagicVendor\GuzzleHttp\Exception as GuzzleExceptions;
use ShopMagicVendor\GuzzleHttp\Promise\PromiseInterface;
use ShopMagicVendor\Http\Adapter\Guzzle7\Exception\UnexpectedValueException;
use ShopMagicVendor\Http\Client\Exception as HttplugException;
use ShopMagicVendor\Http\Promise\Promise as HttpPromise;
