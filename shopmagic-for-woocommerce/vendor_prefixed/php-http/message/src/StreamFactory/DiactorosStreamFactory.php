...
namespace ShopMagicVendor\Http\Message\StreamFactory;

use ShopMagicVendor\Http\Message\StreamFactory;
use ShopMagicVendor\Laminas\Diactoros\Stream as LaminasStream;
use ShopMagicVendor\Psr\Http\Message\StreamInterface;
use ShopMagicVendor\Zend\Diactoros\Stream as ZendStream;
