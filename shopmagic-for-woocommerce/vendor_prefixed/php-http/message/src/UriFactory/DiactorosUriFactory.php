...
namespace ShopMagicVendor\Http\Message\UriFactory;

use ShopMagicVendor\Http\Message\UriFactory;
use ShopMagicVendor\Laminas\Diactoros\Uri as LaminasUri;
use ShopMagicVendor\Psr\Http\Message\UriInterface;
use ShopMagicVendor\Zend\Diactoros\Uri as ZendUri;
