...
namespace ShopMagicVendor\Http\Message\Encoding;

use ShopMagicVendor\Clue\StreamFilter as Filter;
use ShopMagicVendor\Http\Message\Decorator\StreamDecorator;
