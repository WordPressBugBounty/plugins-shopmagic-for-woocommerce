...
use ShopMagicVendor\Http\Discovery\Exception\PuliUnavailableException;
use ShopMagicVendor\Puli\Discovery\Api\Discovery;
use ShopMagicVendor\Puli\GeneratedPuliFactory;
/**
...
class PuliBetaStrategy implements DiscoveryStrategy
{
    ...
    private static function getPuliFactory()
    {
        if (null === self::$puliFactory) {
            if (!defined('ShopMagicVendor\PULI_FACTORY_CLASS')) {
