...
namespace ShopMagicVendor\Http\Discovery\Composer;

use ShopMagicVendor\Composer\Composer;
use ShopMagicVendor\Composer\DependencyResolver\Pool;
use ShopMagicVendor\Composer\EventDispatcher\EventSubscriberInterface;
use ShopMagicVendor\Composer\Factory;
use ShopMagicVendor\Composer\Installer;
use ShopMagicVendor\Composer\IO\IOInterface;
use ShopMagicVendor\Composer\Json\JsonFile;
use ShopMagicVendor\Composer\Json\JsonManipulator;
use ShopMagicVendor\Composer\Package\Locker;
use ShopMagicVendor\Composer\Package\Version\VersionParser;
use ShopMagicVendor\Composer\Package\Version\VersionSelector;
use ShopMagicVendor\Composer\Plugin\PluginInterface;
use ShopMagicVendor\Composer\Repository\InstalledRepositoryInterface;
use ShopMagicVendor\Composer\Repository\RepositorySet;
use ShopMagicVendor\Composer\Script\Event;
use ShopMagicVendor\Composer\Script\ScriptEvents;
use ShopMagicVendor\Composer\Util\Filesystem;
...
class Plugin implements PluginInterface, EventSubscriberInterface
{
    ...
    private const INTERFACE_MAP = ['php-http/async-client-implementation' => ['ShopMagicVendor\Http\Client\HttpAsyncClient'], 'php-http/client-implementation' => ['ShopMagicVendor\Http\Client\HttpClient'], 'psr/http-client-implementation' => ['ShopMagicVendor\Psr\Http\Client\ClientInterface'], 'psr/http-factory-implementation' => ['ShopMagicVendor\Psr\Http\Message\RequestFactoryInterface', 'ShopMagicVendor\Psr\Http\Message\ResponseFactoryInterface', 'ShopMagicVendor\Psr\Http\Message\ServerRequestFactoryInterface', 'ShopMagicVendor\Psr\Http\Message\StreamFactoryInterface', 'ShopMagicVendor\Psr\Http\Message\UploadedFileFactoryInterface', 'ShopMagicVendor\Psr\Http\Message\UriFactoryInterface']];
    ...
    public function getMissingRequires(InstalledRepositoryInterface $repo, array $requires, bool $isProject, array $pinnedAbstractions): array
    {
        ...
        if (ClassDiscovery::safeClassExists(\ShopMagicVendor\Phalcon\Http\Message\RequestFactory::class, \false)) {
