...
use ShopMagicVendor\Http\Discovery\Exception\ClassInstantiationFailedException;
use ShopMagicVendor\Http\Discovery\Exception\DiscoveryFailedException;
use ShopMagicVendor\Http\Discovery\Exception\NoCandidateFoundException;
use ShopMagicVendor\Http\Discovery\Exception\StrategyUnavailableException;
use ShopMagicVendor\Http\Discovery\Strategy\DiscoveryStrategy;
/**
